...
// export const E_ItemOrderDetail = ({ item, index }) => {
...
export const E_ItemOrderDetail = ({
    ...
    return (
        <div className="border-b border-gray-100 pb-3">
            ...
            {/* Expandable section */}
            {isExpanded && (
                <div className="mt-2 p-3 bg-gray-50 rounded-md mx-2 mb-1 animate-fadeIn">
...
export const OrderItems = ({ items }) => {
    ...
    const handleUpdateQuantity = (itemId, newQuantity) => {
        ...
        console.log(`Cập nhật số lượng ${itemId} thành ${newQuantity}`);
    };

    const handleDeleteItem = (itemId) => {
        // Xử lý xóa món
        console.log(`Xóa món ${itemId}`);
    };
